  ...
  return (
    ...
    >
      <div className="flex flex-col items-center space-y-8">
        ...
        {/* Photo Animation Div */}
        <div className="w-full flex justify-center">
          <div className="photo-animation w-24 h-24 sm:w-30 sm:h-30 md:w-36 md:h-36 lg:w-48 lg:h-48 rounded-full shadow-lg overflow-hidden flex justify-center items-center">
            <img
              src={photos[currentPhotoIndex]}
              alt="Photo"
              className="w-full h-full object-cover rounded-full transition-opacity duration-500 ease-in-out"
