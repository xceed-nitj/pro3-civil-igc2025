...
//   return (
//     <div className="bg-transparent container max-w-screen-lg flex flex-col md:items-center lg:flex-row lg:justify-evenly lg:items-start mx-auto -px-8">
...
//         <div
//           id="news"
//           className="w-5/6 min-h-[150px] max-h-[200px]: overflow-scroll bg-gradient-to-r from-[#12105F]  via-purple-800 to-purple-800 rounded-xl p-4"
//         >
//           <div
...
const AboutNews = (props) => {
  ...
  return (
    <div className="bg-transparent container max-w-screen-lg flex flex-col items-center mx-auto px-8 py-10">
      <h2 className="text-4xl font-sans font-bold text-gray-950 mb-4">News</h2>
      <Separator />
      <div
        id="news"
        className="w-full max-w-2xl min-h-[150px] max-h-[200px] overflow-auto bg-gradient-to-r from-[#12105F] via-purple-800 to-purple-800 rounded-xl p-4 mt-4"
      >
        <div
          className={`space-y-4 ${isMouseOver ? "animate-none cursor-default" : "animate-wiggle"}`}
          onMouseOver={() => setIsMouseOver(true)}
