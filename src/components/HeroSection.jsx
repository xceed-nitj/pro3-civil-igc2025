...
//   return (
//     <div className="relative min-h-screen bg-cover bg-center p-4 flex flex-col items-center justify-center">
...
//         </div>
//       </div>
//       <div className="button flex flex-col md:flex-row items-center space-y-4 md:space-y-0 md:space-x-4 mb-8">
...
//       </div>
//       <div className="organi text-center mb-8">
...
//       </div>
//       {/* Countdown Timer for Desktop */}
//       {/* <div className="countdown-container mt-4 text-2xl text-white flex items-end justify-center space-x-4 hidden md:flex" style={{backgroundColor: 'rgba(128, 0, 128, 0.6)', borderRadius: '10px', padding: '10px', maxWidth: '300px'}}>
//         <div className="countdown-item border-r border-white pr-4">
//           <div className="font-semibold">{timeLeft.days}</div>
//           <div className="text-xs">Days</div>
//         </div>
...
//       {/* Countdown Timer for Mobile */}
//       <div className="countdown-container-mobile md:hidden fixed top-80 right-4 mt-4 text-2xl text-white flex flex-col items-end" style={{backgroundColor: 'rgba(128, 0, 128, 0.6)', borderRadius: '10px', padding: '10px', paddingRight: '20px'}}>
//         <div className="countdown-item border-b border-white pb-2">
//           <div className="font-semibold">{timeLeft.days}</div>
//           <div className="text-xs">Days</div>
//         </div>
...
//       {/* Photo Animation */}
//       <div className="photo-animation absolute top-1/2 right-0 transform translate-x-1/2 -translate-y-1/2 w-60 h-60 md:w-96 md:h-96 rounded-full shadow-lg overflow-hidden">
//         <img src={photos[currentPhotoIndex]} alt="Photo" className="w-full h-full object-cover rounded-full transition-opacity duration-500 ease-in-out" />
//       </div>
//     </div>
//   ); 
...
const HeroSection = () => {
  ...
  return (
    ...
    {/* <div className=" relative min-h-screen  bg-cover bg-center p-4 flex flex-col md:flex-row items-center justify-center"> */}
      {/* Content Section */}
      <div className="content flex flex-col items-center md:items-start text-center md:text-left mb-8 md:mb-0">
        ...
        {/* Countdown Timer for Mobile */}
        <div className="countdown-container-mobile md:hidden fixed top-80 right-4 mt-4 text-2xl text-white flex flex-col items-end z-20" style={{backgroundColor: 'rgba(128, 0, 128, 0.6)', borderRadius: '10px', padding: '10px', paddingRight: '20px'}}>
          <div className="countdown-item border-b border-white pb-2">
            <div className="font-semibold">{timeLeft.days}</div>
            <div className="text-xs">Days</div>
          </div>
      ...
      {/* Countdown Timer for Desktop */}
      <div className="countdown-container hidden md:flex flex-col items-end fixed bottom-14 right-10 text-2xl text-white" style={{backgroundColor: 'rgba(128, 0, 128, 0.6)', borderRadius: '10px', padding: '10px', maxWidth: '300px'}}>
        <div className="countdown-item border-b border-white pb-2">
          <div className="font-semibold">{timeLeft.days}</div>
          <div className="text-xs">Days</div>
        </div>
