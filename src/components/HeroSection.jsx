...
//         <p className="by font-light">Organized by:</p>
...
//       <div className="photo-animation absolute top-5 md:top-3 right-5 md:right-20 w-60 h-60 md:w-80 md:h-80 rounded-full shadow-lg overflow-hidden">
