...
// const Footer = () => {
//   return (
//     <footer className="bg-stone-100 lg:grid lg:grid-cols-5 relative bg-cover bg-center" style={{ backgroundImage: "url('bg_contact.png')" }}>
//       <div className="px-4 py-16 sm:px-6 lg:col-span-5 lg:mx-20 "> {/* Adjust background color and opacity for better contrast */}
//         <div className="grid grid-cols-1 gap-8 sm:grid-cols-2">
//           <div>
//             <p className="block text-2xl font-medium text-white hover:opacity-75 sm:text-3xl">
//               Contact Us
//             </p>
...
//           {/* Uncomment and adjust if you need to add footer links */}
//           {/* 
//           <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
//             {footerLinks.map((footerLink) => (
//               <div key={footerLink.id}>
...
const Footer = () => {
  return (
    <footer className="bg-stone-100 relative bg-cover bg-center" style={{ backgroundImage: "url('bg_contact.png')" }}>
