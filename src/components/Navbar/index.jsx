  ...
  return (
    <div className="bg-violet-900 flex flex-col md:flex-row space-y-0 md:space-y-0 md:space-x-4 -mt-2 ml-4">
      <div className="flex flex-col space-y-4 md:space-y-0 md:flex-row md:space-x-10 mt-3">
        ...
        <NavLink to="/sponsorship" className={activeStyleCallback} onClick={onClose} style={{ color: "white" }}>
          SPONSORS
        </NavLink>
        <NavLink to="/speakers" className={activeStyleCallback} onClick={onClose} style={{ color: "white" }}>
          SPEAKERS
        </NavLink>
        <NavLink to="/conference" className={activeStyleCallback} onClick={onClose} style={{ color: "white" }}>
          PRECONFERENCE
        </NavLink>
        <NavLink to="/committee" className={activeStyleCallback} onClick={onClose} style={{ color: "white" }}>
          COMMITTEES
        </NavLink>

        {/* 🆕 Added Travel Tab */}
        <NavLink to="/travel" className={activeStyleCallback} onClick={onClose} style={{ color: "white" }}>
          TRAVEL
        </NavLink>

        <NavLink to="/location" className={activeStyleCallback} onClick={onClose} style={{ color: "white" }}>
          LOCATION
        </NavLink>
        <NavLink to="/accommodation" className={activeStyleCallback} onClick={onClose} style={{ color: "white" }}>
          ACCOMMODATION
        </NavLink>
      </div>
...
const Nav = () => {
  ...
  useEffect(() => {
    switch (location.pathname) {
      ...
      case "/registration":
        setNavTitle("REGISTER");
        break;
      case "/travel": // 🆕 Update for travel route
        setNavTitle("TRAVEL");
        break;
      default:
        setNavTitle("HOME");
  ...
  return (
    <>
      <nav
        className="bg-violet-900 fixed w-full z-10 shadow-lg"
        style={{ margin: 0, padding: 0, top: 0, left: 0 }}
      >
        <div className="container mx-auto flex justify-between items-center py-4 px-4">
          {/* Left Section: Logo + Text */}
          <div className="flex items-center flex-nowrap mr-16">
            <img
              src="logonav.png"
              alt="Logo"
              className="w-5 h-5 md:w-10 md:h-10 mr-2 -ml-2"
        ...
        <AnimatePresence>
          {isOpen && (
            <motion.div
              ...
              className="fixed top-0 left-0 w-80 h-full bg-violet-900 shadow-lg z-20"
            >
              <div className="p-4">
                <div className="flex justify-end mb-4">
                  <button onClick={toggleNavbar} className="p-2">
